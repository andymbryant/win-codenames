...
def get_final_candidates_df(all_candidates, top_candidate_words):
    ...
    if USE_MODEL_PREDICTIONS:
        ...
        models_path = os.path.abspath(os.path.join(DIRNAME, '..', 'reviews/output/models/*'))
        # models_path = os.path.join(dirname, f'output/games_json/game_{game_id}.json')
...
def create_game_record(final_candidates, **kwargs):
    ...
    game_record_output_path = os.path.join(DIRNAME, f'output/games_json/game_{game_id}.json')
